...
var TeamsController = class {
  ...
  async showTasks(request, response, _) {
    const id2 = import_zod.default.string().parse(request.params.id);
    ...
    if (!userTeamsList.includes(id2) && user.role !== import_client2.Roles.admin) throw new AppError("Unauthorized", 401);
